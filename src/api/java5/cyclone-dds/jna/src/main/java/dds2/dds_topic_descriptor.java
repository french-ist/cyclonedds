...
public class dds_topic_descriptor extends Structure {
	 ...
	 */
	public dds2.dds_key_descriptor.ByReference m_keys;
	public dds2.dds_key_descriptor.ByReference getM_keys() {
		return m_keys;
	}
	public void setM_keys(dds2.dds_key_descriptor.ByReference m_keys) {
		this.m_keys = m_keys;
	}
	 ...
	 * C type : const char*
	 */
	public dds_topic_descriptor(NativeSize m_size, int m_align, int m_flagset, int m_nkeys, Pointer m_typename, dds2.dds_key_descriptor.ByReference m_keys, int m_nops, IntByReference m_ops, Pointer m_meta) {
		super();
		this.m_size = m_size;
		this.m_align = m_align;
		this.m_flagset = m_flagset;
