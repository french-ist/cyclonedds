...
/**
 * JNA Wrapper for library <b>dds2</b><br>
 * This file was autogenerated by <a href="http://jnaerator.googlecode.com/">JNAerator</a>,<br>
 * a tool written by <a href="http://ochafik.com/">Olivier Chafik</a> that <a href="http://code.google.com/p/jnaerator/wiki/CreditsAndLicense">uses a few opensource projects.</a>.<br>
 * For help, please visit <a href="http://nativelibs4java.googlecode.com/">NativeLibs4Java</a> , <a href="http://rococoa.dev.java.net/">Rococoa</a>, or <a href="http://jna.dev.java.net/">JNA</a>.
 */
public class Dds2Library implements Library {
	public static final String JNA_LIBRARY_NAME = "dds2";
	public static final NativeLibrary JNA_NATIVE_LIB = NativeLibrary.getInstance(Dds2Library.JNA_LIBRARY_NAME);
	static {
		Native.register(Dds2Library.class, Dds2Library.JNA_NATIVE_LIB);
	}
	/** enum values */
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsEnable(Dds2Library.dds_entity_t entity);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsDelete(Dds2Library.dds_entity_t entity);
	/**
	 ...
	 */
	public static native Dds2Library.dds_entity_t ddsGetPublisher(Dds2Library.dds_entity_t writer);
	/**
	 ...
	 */
	public static native Dds2Library.dds_entity_t ddsGetSubscriber(Dds2Library.dds_entity_t entity);
	/**
	 ...
	 */
	public static native Dds2Library.dds_entity_t ddsGetDatareader(Dds2Library.dds_entity_t condition);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsGetMask(Dds2Library.dds_entity_t condition, IntBuffer mask);
	/**
	 * TODO: document.<br>
	 * Original signature : <code>dds_return_t dds_instancehandle_get(dds_entity_t, dds_instance_handle_t*)</code>
	 */
	public static native Dds2Library.dds_return_t ddsInstancehandleGet(Dds2Library.dds_entity_t entity, LongBuffer ihdl);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsReadStatus(Dds2Library.dds_entity_t entity, IntBuffer status, int mask);
	/**
	 * Description : Read the status(es) set for the entity based on the enabled<br>
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsTakeStatus(Dds2Library.dds_entity_t entity, IntBuffer status, int mask);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsGetStatusChanges(Dds2Library.dds_entity_t entity, IntBuffer status);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsGetEnabledStatus(Dds2Library.dds_entity_t entity, IntBuffer status);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsSetEnabledStatus(Dds2Library.dds_entity_t entity, int mask);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsGetQos(Dds2Library.dds_entity_t entity, Dds2Library.dds_qos_t qos);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsSetQos(Dds2Library.dds_entity_t entity, Dds2Library.dds_qos_t qos);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsGetListener(Dds2Library.dds_entity_t entity, Dds2Library.dds_listener_t listener);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsSetListener(Dds2Library.dds_entity_t entity, Dds2Library.dds_listener_t listener);
	/**
	 ...
	 */
	public static native Dds2Library.dds_entity_t ddsCreateParticipant(int domain, Dds2Library.dds_qos_t qos, Dds2Library.dds_listener_t listener);
	/**
	 ...
	 */
	public static native Dds2Library.dds_entity_t ddsGetParent(Dds2Library.dds_entity_t entity);
	/**
	 ...
	 */
	public static native Dds2Library.dds_entity_t ddsGetParticipant(Dds2Library.dds_entity_t entity);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsGetChildren(Dds2Library.dds_entity_t entity, Dds2Library.dds_entity_t children, NativeSize size);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsGetDomainid(Dds2Library.dds_entity_t entity, IntBuffer id);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsLookupParticipant(int domain_id, Dds2Library.dds_entity_t participants, NativeSize size);
	/**
	 ...
	 */
	public static native Dds2Library.dds_entity_t ddsCreateTopic(Dds2Library.dds_entity_t participant, dds_topic_descriptor descriptor, String name, Dds2Library.dds_qos_t qos, Dds2Library.dds_listener_t listener);
	/**
	 ...
	 */
	public static native Dds2Library.dds_entity_t ddsFindTopic(Dds2Library.dds_entity_t participant, String name);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsGetName(Dds2Library.dds_entity_t topic, String name, NativeSize size);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsGetTypeName(Dds2Library.dds_entity_t topic, String name, NativeSize size);
	/**
	 ...
	 */
	public static native Dds2Library.dds_entity_t ddsCreateSubscriber(Dds2Library.dds_entity_t participant, Dds2Library.dds_qos_t qos, Dds2Library.dds_listener_t listener);
	/**
	 ...
	 */
	public static native Dds2Library.dds_entity_t ddsCreatePublisher(Dds2Library.dds_entity_t participant, Dds2Library.dds_qos_t qos, Dds2Library.dds_listener_t listener);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsSuspend(Dds2Library.dds_entity_t publisher);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsResume(Dds2Library.dds_entity_t publisher);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsWaitForAcks(Dds2Library.dds_entity_t publisher_or_writer, Dds2Library.dds_duration_t timeout);
	/**
	 ...
	 */
	public static native Dds2Library.dds_entity_t ddsCreateReader(Dds2Library.dds_entity_t participant_or_subscriber, Dds2Library.dds_entity_t topic, Dds2Library.dds_qos_t qos, Dds2Library.dds_listener_t listener);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsWaitForHistoricalData(Dds2Library.dds_entity_t reader, Dds2Library.dds_duration_t max_wait);
	/**
	 ...
	 */
	public static native Dds2Library.dds_entity_t ddsCreateWriter(Dds2Library.dds_entity_t participant_or_publisher, Dds2Library.dds_entity_t topic, Dds2Library.dds_qos_t qos, Dds2Library.dds_listener_t listener);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsRegisterInstance(Dds2Library.dds_entity_t writer, LongBuffer handle, Pointer data);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsUnregisterInstance(Dds2Library.dds_entity_t writer, Pointer data);
	/** Original signature : <code>dds_return_t dds_unregister_instance_ih(dds_entity_t, dds_instance_handle_t)</code> */
	public static native Dds2Library.dds_return_t ddsUnregisterInstanceIh(Dds2Library.dds_entity_t writer, long handle);
	/** Original signature : <code>dds_return_t dds_unregister_instance_ts(dds_entity_t, const void*, dds_time_t)</code> */
	public static native Dds2Library.dds_return_t ddsUnregisterInstanceTs(Dds2Library.dds_entity_t writer, Pointer data, Dds2Library.dds_time_t timestamp);
	/** Original signature : <code>dds_return_t dds_unregister_instance_ih_ts(dds_entity_t, dds_instance_handle_t, dds_time_t)</code> */
	public static native Dds2Library.dds_return_t ddsUnregisterInstanceIhTs(Dds2Library.dds_entity_t writer, long handle, Dds2Library.dds_time_t timestamp);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsWritedispose(Dds2Library.dds_entity_t writer, Pointer data);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsWritedisposeTs(Dds2Library.dds_entity_t writer, Pointer data, Dds2Library.dds_time_t timestamp);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsDispose(Dds2Library.dds_entity_t writer, Pointer data);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsDisposeTs(Dds2Library.dds_entity_t writer, Pointer data, Dds2Library.dds_time_t timestamp);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsDisposeIh(Dds2Library.dds_entity_t writer, long handle);
	/**
	 * Description : This operation disposes an instance with a specific timestamp,<br>
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsDisposeIhTs(Dds2Library.dds_entity_t writer, long handle, Dds2Library.dds_time_t timestamp);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsWrite(Dds2Library.dds_entity_t writer, Pointer data);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsWritecdr(Dds2Library.dds_entity_t writer, Pointer cdr, NativeSize size);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsWriteTs(Dds2Library.dds_entity_t writer, Pointer data, Dds2Library.dds_time_t timestamp);
	/**
	 ...
	 */
	public static native Dds2Library.dds_entity_t ddsCreateReadcondition(Dds2Library.dds_entity_t reader, int mask);
	/** Original signature : <code>dds_entity_t dds_create_querycondition(dds_entity_t, uint32_t, dds_querycondition_filter_fn)</code> */
	public static native Dds2Library.dds_entity_t ddsCreateQuerycondition(Dds2Library.dds_entity_t reader, int mask, Dds2Library.dds_querycondition_filter_fn filter);
	/**
	 ...
	 */
	public static native Dds2Library.dds_entity_t ddsCreateWaitset(Dds2Library.dds_entity_t participant);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsWaitsetGetEntities(Dds2Library.dds_entity_t waitset, Dds2Library.dds_entity_t entities, NativeSize size);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsWaitsetAttach(Dds2Library.dds_entity_t waitset, Dds2Library.dds_entity_t entity, Pointer x);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsWaitsetDetach(Dds2Library.dds_entity_t waitset, Dds2Library.dds_entity_t entity);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsWaitsetSetTrigger(Dds2Library.dds_entity_t waitset, byte trigger);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsWaitsetWait(Dds2Library.dds_entity_t waitset, PointerByReference xs, NativeSize nxs, Dds2Library.dds_duration_t reltimeout);
	/**
	 * @brief This operation allows an application thread to wait for the a status<br>
	 *        change or other trigger on (one of) the entities that are attached to<br>
	 *        the WaitSet.<br>
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsWaitsetWaitUntil(Dds2Library.dds_entity_t waitset, PointerByReference xs, NativeSize nxs, Dds2Library.dds_time_t abstimeout);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsRead(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, NativeSize bufsz, int maxs);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsReadWl(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, int maxs);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsReadMask(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, NativeSize bufsz, int maxs, int mask);
	/**
	 ...
	 * @param mask In case of ReadCondition, both masks are applied (OR'd)
	 */
	public static native Dds2Library.dds_return_t ddsReadMaskWl(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, int maxs, int mask);
	/**
	 * @brief Access and read the collection of data values (of same type) and sample info from the<br>
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsReadInstance(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, NativeSize bufsz, int maxs, long handle);
	/**
	 * @brief Access and read loaned samples of data reader, readcondition or querycondition,<br>
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsReadInstanceWl(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, int maxs, long handle);
	/**
	 * @brief Read the collection of data values and sample info from the data reader, readcondition<br>
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsReadInstanceMask(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, NativeSize bufsz, int maxs, long handle, int mask);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsReadInstanceMaskWl(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, int maxs, long handle, int mask);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsTake(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, NativeSize bufsz, int maxs);
	/**
	 ...
	 * @param buf writes_to_ annotation would be nice, however we don't know the size of the elements. Solution for that? Is there a better annotation?
	 */
	public static native Dds2Library.dds_return_t ddsTakeWl(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, int maxs);
	/**
	 ...
	 * @param buf writes_to_ annotation would be nice, however we don't know the size of the elements. Solution for that? Is there a better annotation?
	 */
	public static native Dds2Library.dds_return_t ddsTakeMask(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, NativeSize bufsz, int maxs, int mask);
	/**
	 ...
	 * @param buf writes_to_ annotation would be nice, however we don't know the size of the elements. Solution for that? Is there a better annotation?
	 */
	public static native Dds2Library.dds_return_t ddsTakeMaskWl(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, int maxs, int mask);
	/** Original signature : <code>int dds_takecdr(dds_entity_t, serdata**, uint32_t, dds_sample_info_t*, uint32_t)</code> */
	public static native int ddsTakecdr(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, int maxs, dds_sample_info si, int mask);
	/** Original signature : <code>int dds_takecdr(dds_entity_t, serdata**, uint32_t, dds_sample_info_t*, uint32_t)</code> */
	public static native int ddsTakecdr(Dds2Library.dds_entity_t reader_or_condition, Dds2Library.serdata buf[], int maxs, dds_sample_info si, int mask);
	/**
	 * @brief Access the collection of data values (of same type) and sample info from the<br>
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsTakeInstance(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, NativeSize bufsz, int maxs, long handle);
	/**
	 * @brief Access loaned samples of data reader, readcondition or querycondition,<br>
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsTakeInstanceWl(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, int maxs, long handle);
	/**
	 * @brief Take the collection of data values (of same type) and sample info from the<br>
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsTakeInstanceMask(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, NativeSize bufsz, int maxs, long handle, int mask);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsTakeInstanceMaskWl(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, int maxs, long handle, int mask);
	/**
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsTakeNext(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si);
	/** Original signature : <code>dds_return_t dds_take_next_wl(dds_entity_t, void**, dds_sample_info_t*)</code> */
	public static native Dds2Library.dds_return_t ddsTakeNextWl(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si);
	/**
	 * Description : This operation copies the next, non-previously accessed data value and corresponding<br>
	 *               sample info.<br>
	 * Arguments :<br>
	 ...
	 */
	public static native Dds2Library.dds_return_t ddsReadNext(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si);
	/** Original signature : <code>dds_return_t dds_read_next_wl(dds_entity_t, void**, dds_sample_info_t*)</code> */
	public static native Dds2Library.dds_return_t ddsReadNextWl(Dds2Library.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si);
