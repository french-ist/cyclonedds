...
abstract public class octSeqHelper
{
  private static String  _id = "IDL:DDS/octSeq:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (DDS.octSeqHelper.id (), "octSeq", __typeCode);
    }
    return __typeCode;
  }
