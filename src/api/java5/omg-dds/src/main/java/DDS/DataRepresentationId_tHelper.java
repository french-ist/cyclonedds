...
/**
* DDS/DataRepresentationId_tHelper.java .
...
abstract public class DataRepresentationId_tHelper
{
  private static String  _id = "IDL:DDS/DataRepresentationId_t:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (DDS.DataRepresentationId_tHelper.id (), "DataRepresentationId_t", __typeCode);
    }
    return __typeCode;
  }
