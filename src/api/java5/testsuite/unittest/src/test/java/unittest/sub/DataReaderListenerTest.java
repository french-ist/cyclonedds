...
public class DataReaderListenerTest {
    ...
    private static String                   topicName   = "DataReaderListenerTest";
    private static Msg                      message     = new Msg(0, "DataReaderListenerTest");
    private final static Semaphore          sem         = new Semaphore(0);
    private static DataReaderListenerClass  drl         = null;
    ...
    public static void init() {
        try {
            ...
            env = ServiceEnvironment.createInstance(DataReaderListenerTest.class.getClassLoader());
            ...
            drl = new DataReaderListenerClass(sem);
            assertTrue("Check for valid DataReaderListener object failed", drl instanceof DataReaderListenerClass);
        } catch (Exception e) {
            fail("Exception occured while initiating the DataReaderListenerTest class: " + util.printException(e));
        }
    ...
    public void testOnRequestedIncompatibleQos() {
        ...
        try {
            ...
            dr = subscriber.createDataReader(topic, drq, drl, RequestedIncompatibleQosStatus.class);
            dw = publisher.createDataWriter(topic);

            try {
                triggerOccured = sem.tryAcquire(5, TimeUnit.SECONDS);
            } catch (Exception e) {
        ...
        assertTrue("Check for valid OnRequestedIncompatibleQos value", util.valueCompareCheck("testOnRequestedIncompatibleQos", drl.requestedIncompatibleQosCounter, 0, AbstractUtilities.Equality.GT));
        drl.reset();
    }
    ...
    public void testOnRequestedDeadlineMissed() {
        ...
        try {
            ...
            dr = subscriber.createDataReader(topic, drq, drl, RequestedDeadlineMissedStatus.class);
        ...
        assertTrue("Check for valid RequestedDeadlineMissed value", util.valueCompareCheck("testOnRequestedDeadlineMissed", drl.requestedDeadlineMissedCounter, 0, AbstractUtilities.Equality.GT));
        drl.reset();
    }
    ...
    public void testonLivelinessChanged() {
        ...
        try {
            ...
            dr = subscriber.createDataReader(topic, drq, drl, LivelinessChangedStatus.class);
            Thread.sleep(3000);
            try {
                triggerOccured = sem.tryAcquire(5, TimeUnit.SECONDS);
            } catch (Exception e) {
        ...
        assertTrue("Check for valid testonLivelinessChanged value", util.valueCompareCheck("testonLivelinessChanged", drl.livelinessChangedCounter, 0, AbstractUtilities.Equality.GT));
        drl.reset();
    }
    ...
    public void testOnSubscriptionMatched() {
        ...
        try {
            ...
            dr.setListener(drl, SubscriptionMatchedStatus.class);
            dw = publisher.createDataWriter(topic);
            try {
                triggerOccured = sem.tryAcquire(5, TimeUnit.SECONDS);
            } catch (Exception e) {
        ...
        assertTrue("Check for valid OnSubscriptionMatched value", util.valueCompareCheck("testOnSubscriptionMatched", drl.subscriptionMatchCounter, 0, AbstractUtilities.Equality.GT));
        drl.reset();
    }
    ...
    public void testOnDataAvailable() {
        ...
        try {
            dr = subscriber.createDataReader(topic);
            dr.setListener(drl, DataAvailableStatus.class);
            dw = publisher.createDataWriter(topic);
            dw.write(message);
        ...
        assertTrue("Check for valid OnDataAvailable value", util.valueCompareCheck("testOnDataAvailable", drl.dataAvailableCounter, 0, AbstractUtilities.Equality.GT));
        drl.reset();
    }
    ...
    public void testOnSampleRejected() {
        ...
        try {
            ...
            dr = subscriber.createDataReader(topic, drq, drl, SampleRejectedStatus.class);
        ...
        assertTrue("Check for valid OnSampleRejected value", util.valueCompareCheck("testOnSampleRejected", drl.sampleRejectCounter, 0, AbstractUtilities.Equality.GT));
        drl.reset();
    }
}
