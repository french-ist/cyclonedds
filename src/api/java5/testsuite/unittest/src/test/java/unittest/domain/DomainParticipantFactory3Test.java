...
public class DomainParticipantFactory3Test {

    private final static int                DOMAIN_ID = 300;
    private static ServiceEnvironment       env;
    private static DomainParticipantFactory dpf;
    private static AbstractUtilities        util      = AbstractUtilities.getInstance(DomainParticipantFactory3Test.class);
    ...
    public static void init() {
        ...
        env = ServiceEnvironment.createInstance(DomainParticipantFactory3Test.class.getClassLoader());
    ...
    public void testCreateParticipantInt() {
        /* try a domain outside the valid 0-230 domain range */
