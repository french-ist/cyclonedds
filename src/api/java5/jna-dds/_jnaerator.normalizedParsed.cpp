 ...
 */
typedef bool (*dds_querycondition_filter_fn)(const void* sample) dds_querycondition_filter_fn;
...
int dds_takecdr(dds_entity_t reader_or_condition, serdata** buf, uint32_t maxs, dds_sample_info_t* si, uint32_t mask);
/**
 * @brief Access the collection of data values (of same type) and sample info from the<br>
