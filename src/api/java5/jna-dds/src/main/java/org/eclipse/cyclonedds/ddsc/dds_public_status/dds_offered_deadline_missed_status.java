...
/**
 * <i>native declaration : _dds_public_status.h:54</i><br>
 */
public class dds_offered_deadline_missed_status extends Structure {
	...
	public dds_offered_deadline_missed_status() {
		super();
	}
	...
	public dds_offered_deadline_missed_status(int total_count, int total_count_change, long last_instance_handle) {
		super();
		this.total_count = total_count;
		this.total_count_change = total_count_change;
		this.last_instance_handle = last_instance_handle;
	}
	public dds_offered_deadline_missed_status(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends dds_offered_deadline_missed_status implements Structure.ByReference {
		
	};
	public static class ByValue extends dds_offered_deadline_missed_status implements Structure.ByValue {
