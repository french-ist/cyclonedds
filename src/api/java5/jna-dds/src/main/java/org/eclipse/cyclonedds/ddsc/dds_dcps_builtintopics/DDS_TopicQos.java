...
public class DDS_TopicQos extends Structure {
	...
	protected List<String> getFieldOrder() {
		return Arrays.asList("topic_data", "durability", "durability_service", "deadline", "latency_budget", "liveliness", "reliability", "destination_order", "history", "resource_limits", "transport_priority", "lifespan", "ownership");
	}
	public DDS_TopicQos(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends DDS_TopicQos implements Structure.ByReference {
		
	};
	public static class ByValue extends DDS_TopicQos implements Structure.ByValue {
