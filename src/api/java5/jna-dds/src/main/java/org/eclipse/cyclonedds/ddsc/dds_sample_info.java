...
import org.eclipse.cyclonedds.ddsc.DdscLibrary.dds_time_t;
/**
 * <i>native declaration : dds2tmptmp.h:160</i><br>
...
public class dds_sample_info extends Structure {
	...
	public dds_time_t getSource_timestamp() {
		return source_timestamp;
	}
	public void setSource_timestamp(dds_time_t source_timestamp) {
	...
	/**
	 * NOTE: VLite extension<br>
	 * C type : dds_time_t
	 */
	public dds_time_t reception_timestamp;
	public dds_time_t getReception_timestamp() {
		return reception_timestamp;
	}
	public void setReception_timestamp(dds_time_t reception_timestamp) {
	...
	protected List<? > getFieldOrder() {
		return Arrays.asList("sample_state", "view_state", "instance_state", "valid_data", "source_timestamp", "instance_handle", "publication_handle", "disposed_generation_count", "no_writers_generation_count", "sample_rank", "generation_rank", "absolute_generation_rank", "reception_timestamp");
	}
