...
public class DdscLibrary implements Library {
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsEnable(DdscLibrary.dds_entity_t entity);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsDelete(DdscLibrary.dds_entity_t entity);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_entity_t ddsGetPublisher(DdscLibrary.dds_entity_t writer);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_entity_t ddsGetSubscriber(DdscLibrary.dds_entity_t entity);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_entity_t ddsGetDatareader(DdscLibrary.dds_entity_t condition);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsGetMask(DdscLibrary.dds_entity_t condition, IntBuffer mask);
	/**
	 * TODO: document.<br>
	 * Original signature : <code>dds_return_t dds_instancehandle_get(dds_entity_t, dds_instance_handle_t*)</code>
	 */
	public static native DdscLibrary.dds_return_t ddsInstancehandleGet(DdscLibrary.dds_entity_t entity, LongBuffer ihdl);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsReadStatus(DdscLibrary.dds_entity_t entity, IntBuffer status, int mask);
	/**
	 * Description : Read the status(es) set for the entity based on the enabled<br>
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsTakeStatus(DdscLibrary.dds_entity_t entity, IntBuffer status, int mask);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsGetStatusChanges(DdscLibrary.dds_entity_t entity, IntBuffer status);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsGetEnabledStatus(DdscLibrary.dds_entity_t entity, IntBuffer status);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsSetEnabledStatus(DdscLibrary.dds_entity_t entity, int mask);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsGetQos(DdscLibrary.dds_entity_t entity, DdscLibrary.dds_qos_t qos);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsSetQos(DdscLibrary.dds_entity_t entity, DdscLibrary.dds_qos_t qos);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsGetListener(DdscLibrary.dds_entity_t entity, DdscLibrary.dds_listener_t listener);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsSetListener(DdscLibrary.dds_entity_t entity, DdscLibrary.dds_listener_t listener);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_entity_t ddsCreateParticipant(int domain, DdscLibrary.dds_qos_t qos, DdscLibrary.dds_listener_t listener);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_entity_t ddsGetParent(DdscLibrary.dds_entity_t entity);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_entity_t ddsGetParticipant(DdscLibrary.dds_entity_t entity);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsGetChildren(DdscLibrary.dds_entity_t entity, DdscLibrary.dds_entity_t children, NativeSize size);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsGetDomainid(DdscLibrary.dds_entity_t entity, IntBuffer id);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsLookupParticipant(int domain_id, DdscLibrary.dds_entity_t participants, NativeSize size);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_entity_t ddsCreateTopic(DdscLibrary.dds_entity_t participant, dds_topic_descriptor descriptor, String name, DdscLibrary.dds_qos_t qos, DdscLibrary.dds_listener_t listener);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_entity_t ddsFindTopic(DdscLibrary.dds_entity_t participant, String name);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsGetName(DdscLibrary.dds_entity_t topic, String name, NativeSize size);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsGetTypeName(DdscLibrary.dds_entity_t topic, String name, NativeSize size);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_entity_t ddsCreateSubscriber(DdscLibrary.dds_entity_t participant, DdscLibrary.dds_qos_t qos, DdscLibrary.dds_listener_t listener);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_entity_t ddsCreatePublisher(DdscLibrary.dds_entity_t participant, DdscLibrary.dds_qos_t qos, DdscLibrary.dds_listener_t listener);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsSuspend(DdscLibrary.dds_entity_t publisher);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsResume(DdscLibrary.dds_entity_t publisher);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsWaitForAcks(DdscLibrary.dds_entity_t publisher_or_writer, DdscLibrary.dds_duration_t timeout);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_entity_t ddsCreateReader(DdscLibrary.dds_entity_t participant_or_subscriber, DdscLibrary.dds_entity_t topic, DdscLibrary.dds_qos_t qos, DdscLibrary.dds_listener_t listener);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsWaitForHistoricalData(DdscLibrary.dds_entity_t reader, DdscLibrary.dds_duration_t max_wait);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_entity_t ddsCreateWriter(DdscLibrary.dds_entity_t participant_or_publisher, DdscLibrary.dds_entity_t topic, DdscLibrary.dds_qos_t qos, DdscLibrary.dds_listener_t listener);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsRegisterInstance(DdscLibrary.dds_entity_t writer, LongBuffer handle, Pointer data);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsUnregisterInstance(DdscLibrary.dds_entity_t writer, Pointer data);
	/** Original signature : <code>dds_return_t dds_unregister_instance_ih(dds_entity_t, dds_instance_handle_t)</code> */
	public static native DdscLibrary.dds_return_t ddsUnregisterInstanceIh(DdscLibrary.dds_entity_t writer, long handle);
	/** Original signature : <code>dds_return_t dds_unregister_instance_ts(dds_entity_t, const void*, dds_time_t)</code> */
	public static native DdscLibrary.dds_return_t ddsUnregisterInstanceTs(DdscLibrary.dds_entity_t writer, Pointer data, DdscLibrary.dds_time_t timestamp);
	/** Original signature : <code>dds_return_t dds_unregister_instance_ih_ts(dds_entity_t, dds_instance_handle_t, dds_time_t)</code> */
	public static native DdscLibrary.dds_return_t ddsUnregisterInstanceIhTs(DdscLibrary.dds_entity_t writer, long handle, DdscLibrary.dds_time_t timestamp);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsWritedispose(DdscLibrary.dds_entity_t writer, Pointer data);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsWritedisposeTs(DdscLibrary.dds_entity_t writer, Pointer data, DdscLibrary.dds_time_t timestamp);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsDispose(DdscLibrary.dds_entity_t writer, Pointer data);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsDisposeTs(DdscLibrary.dds_entity_t writer, Pointer data, DdscLibrary.dds_time_t timestamp);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsDisposeIh(DdscLibrary.dds_entity_t writer, long handle);
	/**
	 * Description : This operation disposes an instance with a specific timestamp,<br>
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsDisposeIhTs(DdscLibrary.dds_entity_t writer, long handle, DdscLibrary.dds_time_t timestamp);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsWrite(DdscLibrary.dds_entity_t writer, Pointer data);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsWritecdr(DdscLibrary.dds_entity_t writer, Pointer cdr, NativeSize size);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsWriteTs(DdscLibrary.dds_entity_t writer, Pointer data, DdscLibrary.dds_time_t timestamp);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_entity_t ddsCreateReadcondition(DdscLibrary.dds_entity_t reader, int mask);
	/** Original signature : <code>dds_entity_t dds_create_querycondition(dds_entity_t, uint32_t, dds_querycondition_filter_fn)</code> */
	public static native DdscLibrary.dds_entity_t ddsCreateQuerycondition(DdscLibrary.dds_entity_t reader, int mask, DdscLibrary.dds_querycondition_filter_fn filter);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_entity_t ddsCreateWaitset(DdscLibrary.dds_entity_t participant);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsWaitsetGetEntities(DdscLibrary.dds_entity_t waitset, DdscLibrary.dds_entity_t entities, NativeSize size);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsWaitsetAttach(DdscLibrary.dds_entity_t waitset, DdscLibrary.dds_entity_t entity, Pointer x);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsWaitsetDetach(DdscLibrary.dds_entity_t waitset, DdscLibrary.dds_entity_t entity);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsWaitsetSetTrigger(DdscLibrary.dds_entity_t waitset, byte trigger);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsWaitsetWait(DdscLibrary.dds_entity_t waitset, PointerByReference xs, NativeSize nxs, DdscLibrary.dds_duration_t reltimeout);
	/**
	 * @brief This operation allows an application thread to wait for the a status<br>
	 *        change or other trigger on (one of) the entities that are attached to<br>
	 *        the WaitSet.<br>
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsWaitsetWaitUntil(DdscLibrary.dds_entity_t waitset, PointerByReference xs, NativeSize nxs, DdscLibrary.dds_time_t abstimeout);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsRead(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, NativeSize bufsz, int maxs);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsReadWl(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, int maxs);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsReadMask(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, NativeSize bufsz, int maxs, int mask);
	/**
	 ...
	 * @param mask In case of ReadCondition, both masks are applied (OR'd)
	 */
	public static native DdscLibrary.dds_return_t ddsReadMaskWl(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, int maxs, int mask);
	/**
	 * @brief Access and read the collection of data values (of same type) and sample info from the<br>
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsReadInstance(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, NativeSize bufsz, int maxs, long handle);
	/**
	 * @brief Access and read loaned samples of data reader, readcondition or querycondition,<br>
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsReadInstanceWl(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, int maxs, long handle);
	/**
	 * @brief Read the collection of data values and sample info from the data reader, readcondition<br>
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsReadInstanceMask(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, NativeSize bufsz, int maxs, long handle, int mask);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsReadInstanceMaskWl(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, int maxs, long handle, int mask);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsTake(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, NativeSize bufsz, int maxs);
	/**
	 ...
	 * @param buf writes_to_ annotation would be nice, however we don't know the size of the elements. Solution for that? Is there a better annotation?
	 */
	public static native DdscLibrary.dds_return_t ddsTakeWl(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, int maxs);
	/**
	 ...
	 * @param buf writes_to_ annotation would be nice, however we don't know the size of the elements. Solution for that? Is there a better annotation?
	 */
	public static native DdscLibrary.dds_return_t ddsTakeMask(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, NativeSize bufsz, int maxs, int mask);
	/**
	 ...
	 * @param buf writes_to_ annotation would be nice, however we don't know the size of the elements. Solution for that? Is there a better annotation?
	 */
	public static native DdscLibrary.dds_return_t ddsTakeMaskWl(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, int maxs, int mask);
	/** Original signature : <code>int dds_takecdr(dds_entity_t, serdata**, uint32_t, dds_sample_info_t*, uint32_t)</code> */
	public static native int ddsTakecdr(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, int maxs, dds_sample_info si, int mask);
	/** Original signature : <code>int dds_takecdr(dds_entity_t, serdata**, uint32_t, dds_sample_info_t*, uint32_t)</code> */
	public static native int ddsTakecdr(DdscLibrary.dds_entity_t reader_or_condition, DdscLibrary.serdata buf[], int maxs, dds_sample_info si, int mask);
	/**
	 * @brief Access the collection of data values (of same type) and sample info from the<br>
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsTakeInstance(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, NativeSize bufsz, int maxs, long handle);
	/**
	 * @brief Access loaned samples of data reader, readcondition or querycondition,<br>
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsTakeInstanceWl(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, int maxs, long handle);
	/**
	 * @brief Take the collection of data values (of same type) and sample info from the<br>
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsTakeInstanceMask(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, NativeSize bufsz, int maxs, long handle, int mask);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsTakeInstanceMaskWl(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si, int maxs, long handle, int mask);
	/**
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsTakeNext(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si);
	/** Original signature : <code>dds_return_t dds_take_next_wl(dds_entity_t, void**, dds_sample_info_t*)</code> */
	public static native DdscLibrary.dds_return_t ddsTakeNextWl(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si);
	/**
	 * Description : This operation copies the next, non-previously accessed data value and corresponding<br>
	 *               sample info.<br>
	 * Arguments :<br>
	 ...
	 */
	public static native DdscLibrary.dds_return_t ddsReadNext(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si);
	/** Original signature : <code>dds_return_t dds_read_next_wl(dds_entity_t, void**, dds_sample_info_t*)</code> */
	public static native DdscLibrary.dds_return_t ddsReadNextWl(DdscLibrary.dds_entity_t reader_or_condition, PointerByReference buf, dds_sample_info si);
