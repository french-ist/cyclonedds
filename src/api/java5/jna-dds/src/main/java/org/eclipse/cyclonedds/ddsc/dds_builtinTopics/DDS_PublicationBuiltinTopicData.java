...
/**
 * <i>native declaration : _dds_builtinTopics.h:274</i><br>
 */
public class DDS_PublicationBuiltinTopicData extends Structure {
	...
	public DDS_PublicationBuiltinTopicData() {
		super();
	}
	protected List<String> getFieldOrder() {
		return Arrays.asList("key", "participant_key", "topic_name", "type_name", "durability", "deadline", "latency_budget", "liveliness", "reliability", "lifespan", "destination_order", "user_data", "ownership", "ownership_strength", "presentation", "partition", "topic_data", "group_data");
	}
	public DDS_PublicationBuiltinTopicData(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends DDS_PublicationBuiltinTopicData implements Structure.ByReference {
		
	};
	public static class ByValue extends DDS_PublicationBuiltinTopicData implements Structure.ByValue {
